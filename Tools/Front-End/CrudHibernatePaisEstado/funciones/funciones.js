...
function llenado(){                      //--------Llenar--------
    $.ajax({
        ...
        contentType: 'continentelication/json; charset=utf-8',
        async: false,
        dataType: 'json',
...
$('#cuerpoT').on('click','.btn-warning',function(){
    ...
    $.ajax({
        ...
        success: function(dato){
            ...
            $('#continenteU').val(dato.continente);
 ...
 $('#btnGuardar').click(function()             //--------Botón Guardar--------
 {
     ...
     if(id==''){
        ...
        var json = {"id": id, "nombre": nombre, "continente": continente, "pueblo": pueblo};
        $.ajax({
            type: 'ajax',
            method: 'post',
 ...
 $('#btnEditar').click(function()          //--------Boton Editar--------
 {
    var id = $('#idU').val();
     ...
     var continente = $('#continenteU').val();
